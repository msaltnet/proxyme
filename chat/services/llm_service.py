...
from litellm import acompletion, completion, completion_with_fallbacks
...
class LLMService:
    ...
    def get_response_with_fallback(
        self, user_input: str, fallback_models: List[str] = None, **kwargs
    ) -> str:
    ...
    def get_multiple_responses(
        self, user_input: str, models: List[str], **kwargs
    ) -> Dict[str, str]:
        """여러 모델로 동시 응답 생성"""
        responses = {}
